...
-- keymap({ "n", "v", "o" }, "<leader>ws", "<C-w>w", { desc = "Switch to beteen 2 window" })
...
keymap({ "n", "v", "o" }, "<A-f>", "<C-w>_<C-w>|", { desc = "Max current window" })
...
keymap({ "n", "v", "o" }, "<A-=>", "<C-w>=", { desc = "average size of all windows" })
keymap({ "n", "v", "o" }, "<A-+>", "<Esc>:resize +3<cr>", { desc = "Increase height" })
keymap({ "n", "v", "o" }, "<A-->", "<Esc>:resize -3<cr>", { desc = "Decrease height" })
keymap({ "n", "v", "o" }, "<A-<>", "<Esc>:vertical resize -5<cr>", { desc = "Increase width" })
keymap({ "n", "v", "o" }, "<A->>", "<Esc>:vertical resize +5<cr>", { desc = "Decrease width" })
